                    ...
                    if (newUsername == null || newUsername.trim().isEmpty() || newUsername.length() > 50) {
                        ...
                        if (success) {
                            ...
                            if (passwordUpdateSuccess) {
                                ...
                                currentUsernameFromSession = newUsername.trim(); // Update the local variable
                            } else {
                                request.setAttribute("errorMessage_changeUsername", "Username updated, but failed to update encryption.");
                            }
                        } else {
