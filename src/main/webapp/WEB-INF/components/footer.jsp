...
<footer class="footer">
    <div class="footer-content">
        ...
        <div class="footer-column">
            <h3>Community</h3>
            <ul class="footer-links">
                <li><a href="/Aniverse/forums">Forums</a></li>
                <li><a href="/Aniverse/reviews">User Reviews</a></li>
                <li><a href="/Aniverse/clubs">Clubs</a></li>
                <li><a href="/Aniverse/blogs">Blogs</a></li>
                <li><a href="/Aniverse/discord">Discord Server</a></li>
            </ul>
        </div>
